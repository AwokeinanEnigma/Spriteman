...
namespace Spriteman
{
	public partial class ColorEditDialog : Form
	{
		...
		private void hexBox_TextChanged(object sender, EventArgs e)
		{
			...
			int num;
			bool flag = int.TryParse(array[0], NumberStyles.HexNumber, CultureInfo.CurrentCulture, out num);
			int num2;
			bool flag2 = int.TryParse(array[1], NumberStyles.HexNumber, CultureInfo.CurrentCulture, out num2);
			int num3;
			bool flag3 = int.TryParse(array[2], NumberStyles.HexNumber, CultureInfo.CurrentCulture, out num3);
			if (flag && flag2 && flag3)
			{
