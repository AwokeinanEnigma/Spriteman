	...
	public partial class SpriteEditDialog : Form
	{
		...
		private void previewBox_Paint(object sender, PaintEventArgs e)
		{
			...
			if (this.sprite.Bounds.Width > 0 && this.sprite.Bounds.Height > 0)
			{
				...
				graphics.TranslateTransform((float)(this.previewBox.Width / 2), (float)(this.previewBox.Height / 2));
				if (this.showGuides)
				{
				...
				graphics.ScaleTransform((float)(this.sprite.FlipX ? -1 : 1), (float)(this.sprite.FlipY ? -1 : 1));
				graphics.TranslateTransform(-(float)this.sprite.Origin.X, -(float)this.sprite.Origin.Y);
		...
		private void frameTimer_Tick(object sender, EventArgs e)
		{
			...
			int val = (int)(16.67 / (double)this.speeds[this.speedIndex]);
		...
		private int[] staggerFrames = new int[]
		{
			0,
			1,
			0,
